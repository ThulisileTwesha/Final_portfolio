  ...
  return (
    ...
    <h1 className="text-center text-dark my-5">About</h1>
     ...
     <div id='about_container'>
        <p className=" " id='paragraph' style={{fontSize:"15px", color:"black"}}> 
      ...
      <p className='' id='paragraph' style={{fontSize:"15px", color:"black"}}>I now have experience in a number of coding languages and frameworks. I am still learning and 
